...
\usepackage{hyperref} % automatic links to sections, figures, http, etc...
...
%% The next sections related to mathematics were taken as an example from Prof Tony Roberts at http://www.maths.adelaide.edu.au/anthony.roberts/LaTeX/Src/maths.tex 10/08/2014
